    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-primary via-primary to-primary opacity-30 transform -translate-y-1/2"></div>
              ...
              <Card key={index} className="relative bg-card border-border transition-smooth hover:shadow-lg hover:scale-105 z-10">
                <CardContent className="p-6 text-center">
                  <div className="mb-6 flex justify-center">
                    <div className="p-4 rounded-full hero-gradient shadow-md">
